...
class InstancedLOD {
  ...
  // insertQuadTree(plain_x, plain_y, radius) {
  //   this.quadtree.insert(new Point(plain_x, plain_y, radius));
  // }
  ...
  setTransform(index, matrix4) {
    this.transformation[index] = matrix4;
  }
  ...
  render() {
    ...
    transformation?.forEach((t) => {
      ...
      if (frustum.containsPoint(obj_position)) {
        ...
        // if (cur_dist < 50) console.log("here");
